...
namespace Lighthouse.Controllers
{
    public class AnnouncementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,AnnouncementText,AttachmentData,AttachmentFileName,AttachmentContentType,AnnouncementAttachmentData,AnnouncementAttachmentFileName,AnnouncementAttachmentContentType,NotifyByEmail,NotifyByWebsite,Id,UserName")] Announcements announcements)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Description,AnnouncementText,AttachmentData,AttachmentFileName,AttachmentContentType,AnnouncementAttachmentData,AnnouncementAttachmentFileName,AnnouncementAttachmentContentType,NotifyByEmail,NotifyByWebsite,Id,UserName")] Announcements announcements)
        {
